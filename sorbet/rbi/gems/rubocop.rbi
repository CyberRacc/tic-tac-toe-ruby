...
class RuboCop::Cop::Style::CollectionCompact < RuboCop::Cop::Base
  ...
  def grep_v_with_nil?(param0 = nil); end
  def offense_range(node); end
  def on_csend(node); end
  def on_send(node); end
...
class RuboCop::Cop::Style::SlicingWithRange < RuboCop::Cop::Base
  ...
  def on_send(node); end
  def range_from_zero?(param0 = nil); end
  def range_from_zero_till_minus_one?(param0 = nil); end
...
class TicTacToe
  def initialize; end
  def show_board; end
  def update_board(row, index, symbol); end
  def user_name; end
  def user_symbol; end
  def welcome_message; end
end
class Player
  def display_player_info; end
  def initialize(name, symbol); end
  def name; end
  def symbol; end
end
